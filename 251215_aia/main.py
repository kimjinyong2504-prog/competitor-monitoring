...
# -*- coding: utf-8 -*-
"""
AIA(아이아) 뉴스 크롤링 및 자동 업데이트 메인 스크립트
"""
...
from crawler import AIANewsCrawler
...
def update_news_now():
    ...
    if crawler_instance is None:
        crawler_instance = AIANewsCrawler()
...
def start_web_server(port=8002):
    """웹 서버 시작"""
    ...
    for attempt in range(10):
        ...
        print(f"사용 가능한 포트를 찾을 수 없습니다. (8002-8011 시도)")
...
def main():
    ...
    print("="*60)
    print("AIA(아이아) 뉴스 크롤링 및 모니터링 시스템")
    print("="*60)
    print()
