...
from crawler import YuilNewsCrawler
...
def update_news_now():
    ...
    if crawler_instance is None:
        crawler_instance = YuilNewsCrawler()
...
def start_web_server(port=8001):
    ...
    for attempt in range(10):
        ...
        print(f"사용 가능한 포트를 찾을 수 없습니다. (8001-8010 시도)")
